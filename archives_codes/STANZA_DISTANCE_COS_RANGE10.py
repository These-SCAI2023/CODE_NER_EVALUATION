...
def liste_resultats(texte, nlp=stanza.Pipeline("fr", processors = "tokenize,ner")):
    doc = nlp(texte)
    list_resultats =[]
...
#            print(ent)
            if ent.type =="LOC":
#                list_resultats.append([ent.text, ent.type])
...
path_corpora = "../DATA/corpora_stanza/*/"
# dans "corpora" un subcorpus = toutes les versions 'un texte'


#print("Starting with modèle %s")
...
#        print(path)
        ...
        path_output = "%s_stanza.json"%(path)
#        print(path_output)
#        
